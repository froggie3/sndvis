...
import { BrightnessMapStrategy, PhaseHueStrategy, FreqGradientStrategy } from './ConcreteStrategies.js';
...
export class ColorStrategyFactory {
    ...
    private static strategies: Record<VisualizerColorMode, IColorStrategy> = {
        'BrightnessMap': new BrightnessMapStrategy(),
    ...
    static getStrategy(mode: VisualizerColorMode): IColorStrategy {
        return this.strategies[mode] || this.strategies['BrightnessMap'];
    }
}
